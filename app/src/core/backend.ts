...
export class Backend extends EventEmitter {
  ...
  private readonly sessionInterval = new AsyncLoop(async () => { await this.getSession() }, 1000 * 30)
  private readonly syncInterval = new AsyncLoop(async () => { await this.sync() }, 1000 * 5)
  ...
  public constructor (private readonly context: ChatManager) {
    super()
  ...
  async deleteChat (id: string) {
    ...
    return await this.post(endpoint + '/delete', { id })
  }
