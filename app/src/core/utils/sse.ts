...
export default class SSE {
  ...
  private readonly payload = this.options.payload !== undefined ? this.options.payload : ''
  private readonly method = this.options.method ? this.options.method : (this.payload ? 'POST' : 'GET')
  private readonly withCredentials = !!this.options.withCredentials
  ...
  /**
     ...
     */
  private readonly onStreamProgress = (e: any) => {
    if (!this.xhr) {
      return
    }
  ...
  /**
     ...
     */
  private readonly parseEventChunk = (chunk: string) => {
  ...
  /**
     ...
     */
  private readonly onStreamLoaded = (e: any) => {
  ...
  /**
     ...
     */
  private readonly dispatchEvent = (e: any) => {
    if (!e) {
      return true
    }
  ...
  /**
     ...
     */
  private readonly setReadyState = (state: number) => {
  ...
  /**
     ...
     */
  private readonly onStreamFailure = (e: { currentTarget: { response: any } }) => {
  ...
  /**
     ...
     */
  private readonly onStreamAbort = (e: any) => {
  ...
  /**
     ...
     */
  private readonly checkStreamClosed = () => {
    if (!this.xhr) {
      return
    }
