...
import { type PluginDescription } from '../plugins/plugin-description'
import { type Option } from './option'
import { type YChat, type YChatDoc } from '../chat/y-chat'
...
export class OptionsManager extends EventEmitter {
  ...
  private readonly optionsCache = new Map<string, any>()

  constructor (private readonly yDoc: YChatDoc, private readonly pluginMetadata: PluginDescription[]) {
    super()
